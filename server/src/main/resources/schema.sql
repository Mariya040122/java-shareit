...
CREATE TABLE IF NOT EXISTS PUBLIC.ITEMS (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, NAME VARCHAR NOT NULL, DESCRIPTION VARCHAR NOT NULL, AVAILABLE BOOL NOT NULL, OWNER BIGINT NOT NULL, REQUEST_ID BIGINT NULL, CONSTRAINT PK_ITEM PRIMARY KEY (ID));
